...
def calibrate_shaper(datas: List[np.ndarray],
...
def main():
    ...
    fig = shaper_calibration(
        args, options.klipperdir, options.max_smoothing, options.scv, options.max_freq, options.accel_per_hz, 'unknown', include_smoothers
    )
